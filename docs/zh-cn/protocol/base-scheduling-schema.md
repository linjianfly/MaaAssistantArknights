...
{
    "title": "换班方案", // 作业名，可选
    "description": "养老", // 作业描述，可选
    "plans": [
        {
            "name": "a班", // 计划名，可选
            "description": "666", // 计划描述，可选
            ...
            "Fiammetta": {
                ...
                "target": "晓歌", // 目标干员，使用 OCR 进行，需要传入对应客户端语言的干员名
                "order": "pre" // 在整个换班前使用，还是换完班才用，可选，取值范围 "pre" / "post"，默认 "pre"
            },
            "drones": {
                // 无人机使用，可选，不填写则不使用无人机
                "enable": true, // 是否使用无人机，可选，默认 true
                "room": "manufacture", // 为哪个类型房间使用，取值范围 "trading" / "manufacture"
            ...
            "rooms": {"mannufacture"/"trading"/"meeting"/"hire"
                // 房间信息，必选
